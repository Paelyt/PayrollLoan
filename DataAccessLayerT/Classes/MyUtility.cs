...
namespace DataAccessLayerT
{
    public class MyUtility
    {
        ...
        public static string isDates(string date)
        ...
        public static bool isFloat(string amount)
        ...
        public static string GeneratePassword()
        {
            ...
            return UnixTimeStampUtc().ToString() + Create7DigitString(2);
            //  return InstantTimeTicks + InstantTimeSeconds;
        }
