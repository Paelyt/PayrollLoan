    ...
    public class DataReader
    {
       ...
       public List<AppLoan> GetDocument(int Users,string RefNum)
        ...
        public List<LoansLedger> getLedgerRecord(string Refnum)
        {
            try
            {
                var record = (from a in uvDb.LoansLedgers where a.RefNumber == Refnum select a).ToList();
        ...
        public AppLoan GetLoanApplication(string LoanID, int AppstatFk)
        {
            try
            {
                var AppLoan = (from a in uvDb.LoanApplications
                               ...
                               select new AppLoan
                               {
                                   LengthOfService = (int)m.LengthOfServiceInMth,
                ...
                var AppLoan = (from a in uvDb.LoanApplications
                               ...
                               select new Classes.LoanApplication
                               {
                                  ...
                                  // LoanProduct = h.LoanProduct1,
                                   ...
                                   LOS = (int)m.LengthOfServiceInMth,
      ...
      //  public bool Validate(string value)
        ...
        public List<LoanApplication> GetMyApplicationsStatus(string userid)
        {
            try
            {
        ...
        public List<LoanApplication> GetLoans(int instFK)
        {
            try
            {
                ...
                var Loans = (from a in uvDb.LoanApplications
                             join b in uvDb.Institutions on a.Institution_FK equals b.ID  where a.ApplicationStatus_FK == 3 && b.InstitutionType_FK == 2 && a.Institution_FK == instFK  select a ).ToList();
